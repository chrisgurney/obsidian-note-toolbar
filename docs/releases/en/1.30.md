...
- The `prefixes` option lets you provide prefixes that provide suggester results when typed. Per the example below, when `#` is typed, a list of tag suggestions will be shown.
