...
- When opening the main Note Toolbar settings tab, a console error might have appeared if you had a lot of toolbars: `[Violation] Forced reflow while executing JavaScript took Xms`. This error should no longer show, and as a side-effect of the fix, the screen should display a little more quickly. [#389](https://github.com/chrisgurney/obsidian-note-toolbar/issues/369)
