...
### Text toolbar support in Reading mode

Text toolbars now appear when selecting text in Reading mode.
...
- Text toolbars: Pressing `Escape` now dismisses the toolbar.
...
Now also returns any selected text in Reading mode.
