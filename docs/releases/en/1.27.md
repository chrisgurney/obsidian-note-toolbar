...
After enabling **Add toolbar command**, choose where to open the toolbar: as a floating toolbar (default), as a menu, or in a Quick Tools menu.
...
Menus by default appear next to the toolbar item that triggered it. However, since you can [execute toolbar items from commands](https://github.com/chrisgurney/obsidian-note-toolbar/wiki/Creating-toolbar-items#more-actions), it might be useful to open menus in other locations, such as at the cursor (falling back to the mouse position):
