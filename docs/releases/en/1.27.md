...
- IDs are now added to menus and menu items, so they can be individually styled in CSS. Note that Obsidian's _Appearance → Native menus_ option must be _disabled_, in order to style menus.
