...
Select a toolbar to appear in Web viewer tabs. The [Web viewer core plugin ↗](https://help.obsidian.md/plugins/web-viewer) must be enabled to see this setting.
