...
<img width="400" alt="Screenshot showing desktop and reading mode indicators on item list" src="https://github.com/user-attachments/assets/4bf8bb5e-a1b0-48f7-b68e-939c1d2c6f47" />

If an item is not visible on the current platform or mode, and indicator will appear next to the item in the toolbar's item list. When that item is opened, the applicable visibility setting will be highlighted.
