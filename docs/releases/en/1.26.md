...
- Use [Style Settings ↗](https://github.com/mgmeyers/obsidian-style-settings/tree/main) to further customize: item colors + sizes, border colors + radius, maximum width, and the toolbar's shadow.
...
- Toolbars with breaks will have empty gaps on the left and/or right sides. You will have to remove breaks and use the **Max width** Style Setting (or add a CSS snippet) to resolve this.
