...
- [Style Settings ↗](https://github.com/mgmeyers/obsidian-style-settings/tree/main) support, to further customize: item colors + sizes, border colors + radius, and the toolbar's shadow.
