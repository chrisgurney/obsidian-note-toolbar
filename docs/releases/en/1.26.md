...
- Some of the toolbar's styles (e.g., borders) are applied; others won't have an effect (e.g., sticky).
- Put keyboard focus in the text toolbar using the command `Note Toolbar: Focus in text toolbar`.
