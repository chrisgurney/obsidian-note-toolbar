...
- For users  [Cupertino theme ↗](https://github.com/aaaaalexis/obsidian-cupertino), the Liquid Glass effect is applied to `button items`. _Thanks again @aaaaalexis!_
