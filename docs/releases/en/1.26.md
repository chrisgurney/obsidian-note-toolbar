...
Use the `Toggle Base toolbar` command to show/hide any native Base toolbars, including in embedded Bases.
...
- [Cupertino theme ↗](https://github.com/aaaaalexis/obsidian-cupertino): Liquid Glass effect on `button items`. _Thanks @aaaaalexis!_
