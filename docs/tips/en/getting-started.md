...
In Obsidian's settings go to [**Note Toolbar → + New toolbar**](obsidian://note-toolbar?new=toolbar), or [open the Gallery](obsidian://note-toolbar?gallery=open) and choose an item to get your toolbar started.
