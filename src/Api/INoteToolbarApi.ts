...
export interface INoteToolbarApi<T> {
     ...
     * @param items Optional array containing the values of each item in the correct order.
     * @param options.placeholder Placeholder string of the prompt.
     ...
     */
    suggester: (text_items: string[] | ((item: T) => string), items?: T[], options?: NtbSuggesterOptions) => Promise<T | null>;
