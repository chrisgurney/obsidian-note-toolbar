 ...
 * 
 * The Note Toolbar API provides toolbar access, and the ability to show UI (suggesters, prompts, and modals). The latter enables Dataview JS, JS Engine, or Templater scripts to ask for information, or to show helpful text.
 * 
